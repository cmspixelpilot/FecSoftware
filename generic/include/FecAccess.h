...
/** \brief constructor for the uTCA FEC Access
    */
   FecAccess ( const std::string& strFilename, const std::string& strBoardId, const std::string& strUri, const std::string& strAddressTable, bool forceAck, bool initFec, 
                       bool scanFECs, bool scanCCUs,
		       tscType16 i2cSpeed, bool invertClockPolarity ) throw (FecExceptionHandler );
...
//Edit G. Auzinger
  static FecAccess *createUtcaFecAccess ( const std::string& dummyfile, const std::string& fecHardwareId, const std::string& fecUri, const std::string& fecAddressTable, unsigned int i2cSpeed = 100, bool invertClockPolarity = false, bool init = true ) throw (FecExceptionHandler); 
